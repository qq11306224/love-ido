...
abstract contract Ownable is Context {
        ...
        address private _idoWallet = 0xe2EC4989E50A311c89D9f2A8164F2472d7Cc2D49;

        IERC20 usdtToken = IERC20(0x55d398326f99059ff775485246999027b3197955);
        //当前阶段
        uint256 public currentLevelUsdt = 25 * 10 ** 18;
        //一阶段
        uint256 public oneLevelUsdt = 25 * 10 ** 18;

        //二阶段
        uint256 public twoLevelUsdt = 31 * 10 ** 18;
        //三阶段
        uint256 public threeLevelUsdt = 39 * 10 ** 18;
        //IDO 5LOVE
        uint256 public returnedTokenAmount = 5 * 10 ** 18;
        //邀请费率
        uint256 public inviteReward = 10;
        //1000*25 + 1000*31 + 1000* 39  私募总量
        uint256 public maxUsdts = (1000*25 + 1000*31+1000*39) * 10 ** 18;
        // 代币合约地址
        ...
        constructor(){
        marketWallet = 0xc328576aa0A9008f21E51b0F49B2dA66FC6e1D09;
        ...
        function setCurrentLevelUsdt(uint256 _Usdt) external onlyOwner {
        currentLevelUsdt = _Usdt;
        }
        ...
        //二阶段 
        if(address(this).balance >= oneLevelUsdt * 1000  &&  address(this).balance <   (oneLevelUsdt * 1000 + twoLevelUsdt * 1000) ){
        currentLevelUsdt =  twoLevelUsdt;
        }
        //三阶段
        if(address(this).balance >= (oneLevelUsdt * 1000 + twoLevelUsdt * 1000)  &&  address(this).balance <  maxUsdts ){
        currentLevelUsdt =  threeLevelUsdt;
        }
